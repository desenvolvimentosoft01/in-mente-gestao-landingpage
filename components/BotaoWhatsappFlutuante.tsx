...
export default function BotaoWhatsappFlutuante() {
  return (
    <a
      ...
      className="animate-pulse-glow fixed bottom-5 right-5 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-emerald-500 text-white shadow-xl shadow-emerald-500/40 transition duration-300 hover:scale-110 hover:bg-emerald-400 md:bottom-8 md:right-8"
    >
