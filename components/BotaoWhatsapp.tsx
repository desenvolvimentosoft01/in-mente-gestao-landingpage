...
export default function BotaoWhatsapp({
  ...
  return (
    <a
      ...
      className={`inline-flex items-center gap-2 rounded-full bg-emerald-500 px-6 py-3 font-semibold text-white shadow-lg shadow-emerald-500/30 transition duration-300 hover:scale-105 hover:bg-emerald-400 hover:shadow-emerald-500/50 ${className}`}
    >
